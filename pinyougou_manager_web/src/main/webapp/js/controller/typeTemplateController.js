        ...
        methods: {
            ...
            getById: function (id) {
                axios.get("../typeTemplate/getById.do?id=" + id).then(function (response) {
                    ...
                    /*app.entity.brandList = JSON.parse(app.entity.brandList);
                    app.entity.specList = JSON.parse(app.entity.specList);
                    app.customAttributeItems=JSON.parse(app.customAttributeItems);*/
                    //转换品牌列表为json
